...
# --- 新增：Setting for the train_m data-loader (中间层) ---
_C.DATALOADER.TRAIN_M = CN()
_C.DATALOADER.TRAIN_M.SAME_AS_X = True # 可以设置为 True，继承 TRAIN_X 的 batch_size 等
_C.DATALOADER.TRAIN_M.SAMPLER = "RandomSampler"
_C.DATALOADER.TRAIN_M.BATCH_SIZE = 32 # 也可以单独指定一个值
_C.DATALOADER.TRAIN_M.N_DOMAIN = 0
_C.DATALOADER.TRAIN_M.N_INS = 16
